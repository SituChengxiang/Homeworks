...
% 参数：时间（未使用，但必须保留接口）状态向量 [theta1; theta2; omega1; omega2] 几何参数 l1, l2, m1, m2, g
...
foceVector = [ -m2 * l2 * sin(theta1 - theta2) * omega2^2 - (m1 + m2) * g * sin(theta1);
            l1 * sin(theta1 - theta2) * omega1^2 - g * sin(theta2) ];

% 求解角加速度，直接除
alpha = massMatrix \ foceVector;
